...
export interface Config {
  ...
  globalsSelect: {
    ...
    currenciesList: CurrenciesListSelect<false> | CurrenciesListSelect<true>;
  };
  locale: 'en' | 'ar';
  user: User & {
    collection: 'users';
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "currenciesList".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "currenciesList_select".
 */
export interface CurrenciesListSelect<T extends boolean = true> {
  currencies?:
    | T
    | {
        currency?: T;
